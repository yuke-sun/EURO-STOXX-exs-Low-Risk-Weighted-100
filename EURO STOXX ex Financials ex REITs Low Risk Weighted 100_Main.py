...
# rank #
# method 1
# rule_4 = rule_builder.rank(attribute = ['vol'], percentage= [1], sort_order= ['asc'], tie_breaker='ffmcap', missing_data_usage= 'lowest rank')
# rule_5 = rule_builder.filter_simple(attribute='rank', operator='<=', value = 100 ,dataset_id = 'parent_universe')
...
rule_7 = rule_builder.weight_by_attribute(attribute='divide_inverse_vol',dataset_id = 'index_universe')
...
index_def_result_all.to_csv( directory + "\\IDT_output_comp_update2.csv")
